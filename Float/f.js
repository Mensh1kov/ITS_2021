...
function orderToBin(order)  { // перевод порядка в 2-ю систему
    ...
    switch (order) {
        ...
        default:
            if (order < 0) {
                ...
                let i = 0;
                while (mantissa.charAt(i)) { // порядок достигли, но мантиса не кончилась
...
function calculation(num1, num2) {
    let a = num1.split(' '),
        ...
        mantissa,
        mantissa1, // мантисса наиб числа (в частности для вычитания, из большего меньшее...)
        mantissa2,
